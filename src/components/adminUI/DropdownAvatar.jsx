...
const DropdownAvatar = ({ avatar }) => {
  ...
  return (
    <div className="w-[150px] relative flex flex-row-reverse items-center">
      <figure
      ...
      <div
        ...
        px-5 max-w-[135px] z-10 rounded-2xl text-sm text-light_color 
         h-[25px] flex items-center pr-5"
        title={userName}
      >
      ...
      <ul
        className={`w-[150px] h-[100px] absolute right-0 top-2 bg-primary_color shadow-bx-3 
